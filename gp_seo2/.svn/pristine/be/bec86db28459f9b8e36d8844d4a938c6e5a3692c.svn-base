...
<div class="selection float">
    ...
    <div id="summary_table1"></div>
    <div class="clear"></div>
    <p>Bookmark keyword</p>
    <div id="summary_table2"></div>
    ...
    <div id="detail_table1"></div>
    <div class="clear"></div>
    <p>Bookmark keyword</p>
    <div id="detail_table2"></div>
    <?php $this->endWidget('application.extensions.jui.ETab'); ?>
    <?php $this->endWidget('application.extensions.jui.ETabs') ?>
    <script src="<?php echo Yii::app()->request->baseUrl?>/css/js/competekeyword.js"></script>
